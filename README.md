# CustomerOrderTrackingSystem
 ...
 Restful API called to display all the customer details:http://localhost:8080/customers/


 2)Using this application User can view the particular Customer full details.

 Restful API called to display the customer full details:http://localhost:8080/customers/{customerId}
 ...
 Restful API called to display all the orders of the particular customer full details:
 ...
 Restful API called to display the the particular order full details along with the items that he/she has ordered by that particular customer:
